...
public class CM_ClientContractPage extends LoadableComponent<CM_ClientContractPage> {
	...
	@FindBy(xpath = "//a[@class='router-link-active']//span[contains(text(),'Client')]")
	WebElement link_Client;
	...
	public CM_ClientContractPage(WebDriver driver) {
	...
	public void switchToClientProfilePage() throws Exception
	{
		/*
		 * Created By : M Likitha Krishna
		 * Created On :29 April 2020
...
//		input.sendKeys(path.getAbsoluteFile().toString()); 
	...
	public void verifyBreadcrumbs()
	{
		 ...
		 * Created On : 13 May 2020
		 */
		Utils.clickElement(driver, link_Client, "client link to verify breadcrumbs");
	}
	
	
	public void verifyClientAndSponserName(String corpName, String clientName)
	{
		/*
		 * Created By : M Likitha Krishna
		 * Created On : 15 May 2020
		 */
		Utils.verifyIfDataPresent(driver, "//a[contains(text(),'"+clientName+"')]", "xpath", clientName, "client name");
		Utils.verifyIfDataPresent(driver, "//p[contains(text(),'Employer and Sponsor:')]//a[contains(text(),'"+corpName+"')]", "xpath", corpName, "Employer and Sponsor");
	}
...
//        	btn_browse.sendKeys(path.getAbsoluteFile().toString());
	...
	public void verifyEmployeeDetails()
	{
		 ...
		 * Created On : 24 June 2020
		 */
		Utils.verifyIfDataPresent(driver, "//span[contains(text(),'Active')]", "xpath", "Active", "Employee Status");
		Utils.verifyIfDataPresent(driver, "//span[contains(text(),'Employee')]", "xpath", "Employee", "Employee Category");
	}
...
//		Utils.verifyIfDataPresent(driver, "//h4/a[contains(text(),'"+templateName+"')]/../following-sibling::div//button[contains(text(),'Resend Email')]", "xpath", "Resent button", "contracts page");
	...
	public void verifyEmployeeId(String employeeId) throws Exception
	{
		/*
		 * Created By : M Likitha Krishna
		 * Created On : 28 July 2020
		 */
		Utils.verifyIfDataPresent(driver, "//a[contains(text(),'"+employeeId+"')]", "xpath", employeeId, "employee ID in client contracts page");
	}
