...
public class CM_CorporationAdvancedCaseRequestTemplatePage extends LoadableComponent<CM_CorporationAdvancedCaseRequestTemplatePage> {
	...
	@FindBy(xpath = "//td[contains(text(),'Questionnaire For Initiator')]//ancestor::tr[3]/preceding-sibling::tr//input[@id='btn_AddorRemoveQuestionnaires']")
	WebElement btn_addRemoveQuestionnaire;				//Added by Yatharth Pandya on 17th Sept, 2020

	@FindBy(id = "LMLeftTab5")
	WebElement tab_questionnaire;		//Added by Yatharth Pandya on 17th Sept, 2020

	
	
	public CM_CorporationAdvancedCaseRequestTemplatePage(WebDriver driver) {
...
//		txtbox_searchQuestionnaire.clear();
		...
		Utils.switchWindows(driver, "kb_caserequest_template_quest_list.aspx", "url", "false");
