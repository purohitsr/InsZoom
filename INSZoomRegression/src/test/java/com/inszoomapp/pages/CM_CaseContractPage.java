...
public class CM_CaseContractPage extends LoadableComponent<CM_CaseContractPage> {
	...
	@FindBy(xpath = "//a[@class='router-link-active']//span[contains(text(),'Case')]")
	WebElement link_Case;
	...
	public CM_CaseContractPage(WebDriver driver) {
	...
	public void switchToCaseProfilePage() throws Exception
	{
		/*
		 * Created By : M Likitha Krishna
		 * Created On :29 April 2020
	...
	public void verifySearchBox(String templateName)
	{
		...
		Utils.enterText(driver, searchBox_Contracts, "JUNK TEXT", "search box");
...
//		if (!path.exists())
//			Log.fail("File not found in the path specified: " + path.toString()); 
...
//		input.sendKeys(path.getAbsoluteFile().toString()); 
	...
	public void verifyBreadcrumbs()
	{
		 ...
		 * Created On : 13 May 2020
		 */
		Utils.clickElement(driver, link_Case, "case link to verify breadcrumbs");
	}
	
	public void verifyClientCaseDetails(String caseId, String clientName, String corpName)
	{
		/*
		 * Created By : M Likitha Krishna
		 * Created On : 15 May 2020
		 */
		Utils.verifyIfDataPresent(driver, "//a[contains(text(),'"+clientName+"')]", "xpath", clientName, "as client name");
		Utils.verifyIfDataPresent(driver, "//p[contains(text(),'Corporation:')]//a[contains(text(),'"+corpName+"')]", "xpath", corpName, "as corporation");
		Utils.verifyIfDataPresent(driver, "//a[contains(text(),'"+caseId+"')]", "xpath", caseId, "case ID");
		Utils.verifyIfDataPresent(driver, "//p[contains(text(),'Sponsor:')]//a[contains(text(),'"+corpName+"')]", "xpath", corpName, "as sponsor");
	}
	...
	public void verifyCountry(String countryName, String countryFlag)
	{
		/*
		 * Created By : M Likitha Krishna
		 * Created On : 25 June 2020
		 */
		Utils.verifyIfDataPresent(driver, "//span[contains(text(),'"+countryName+"')]", "xpath", countryName, "country name");
		Utils.verifyIfDataPresent(driver, "//span[contains(text(),'"+countryName+"')]//following-sibling::img[@src='"+countryFlag+"']", "xpath", countryFlag, "country flag");
	}
